...
interface LegalCaseInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "mintLegalCase(string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mintLegalCase",
    values: [string]
  ): string;
...
export class LegalCase extends BaseContract {
